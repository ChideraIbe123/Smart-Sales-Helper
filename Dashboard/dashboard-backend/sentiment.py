...
def get_large_audio_transcription_fixed_interval(path, minutes=5):
    ...
    file_handle = sound.export("/Users/maanavagrawal/Documents/Tik-Tok-Trend-Mapper/output.wav", format='wav')
...
path = "/Users/maanavagrawal/Documents/Tik-Tok-Trend-Mapper/testaudio.m4a"
