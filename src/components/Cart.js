...
const Cart = () => {
    ...
    const cartTotal = cartItems.map(item => item.price ).reduce((prevValue, currValue) => prevValue + currValue, 0);
...
const imagespath = item.images[0];
                                            ...
                                            return (
                                                <div className="cart_items" key={id}>
                                                    <figure className="cart_items_img">
                                                        <img src={imagespath} alt="product-img" />
                                                    </figure>
